...
# Starts with shebang, then tells script that it's going to be a bash script
...
# cd (change directory) to the location (path) where data for the Population Genomics module live:
