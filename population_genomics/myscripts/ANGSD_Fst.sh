...
# This script will use ANGSD to estimate Fst between my red spruce pop and black spruce from outside the range
# Path to my repo
REPO="/users/k/a/kaeller/projects/eco_genomics_2025/population_genomics"

# Path to black spruce
